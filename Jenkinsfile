            ...
            steps{
        		...
        		script{
        		   ...
        		   env.TARGET = 'http://zero.webappsecurity.com'        	
                    ...
                    sh '${DOCKER_EXEC} run --user $(id -u):$(id -g) --add-host="localhost:192.168.1.86" -v /var/jenkins_home:/zap/wrk/:rw --rm -i owasp/zap2docker-stable zap-baseline.py -t "http://zero.webappsecurity.com"
 -I -r zap_baseline_report.html -l PASS'	
