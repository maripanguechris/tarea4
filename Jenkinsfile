            ...
            steps{
        		...
        		script{
        		   ...
        		   env.TARGET = 'https://demo.testfire.net/'
                    ...
                    sh '${DOCKER_EXEC} run --add-host="localhost:192.168.1.86" -v //var/jenkins_home/tools:/zap/wrk/:rw --rm -i owasp/zap2docker-stable zap-baseline.py -t "https://demo.testfire.net/" -I -r zap_baseline_report.html -l PASS'	
